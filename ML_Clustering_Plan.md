...
## 🎯 Project Objective
To apply, optimize, and compare multiple clustering algorithms on a dataset (e.g., our modernized `Ship_Performance_Dataset_Modernized.csv`) to identify inherent groupings, and evaluate their performance using internal validation metrics.
