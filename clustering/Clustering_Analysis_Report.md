...
**File analysed:** `data/Ship_Performance_Dataset.csv`
**Clustering notebook:** `clustering/Ship_Clustering.Rmd` → `clustering/Ship_Clustering.html`
...
| Path | Description |
|---|---|
| `data/Ship_Performance_Dataset.csv` | Raw dataset |
| `EDA/Ship_EDA.Rmd` / `.html` | Exploratory data analysis |
| `clustering/Ship_Clustering.Rmd` / `.html` | Clustering analysis (current — v6) |
| `clustering/Clustering_Analysis_Report.md` | This document |
| `clustering/ML_Clustering_Plan.md` | Clustering plan and rationale |
| `clustering/Clustering_Ship.R` | Standalone R script for focused clustering |
| `classification/Ship_Classifier.Rmd` / `.html` | Supervised classifier (next step) |
